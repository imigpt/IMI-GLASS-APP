...
class MeetingMinutesActivity : AppCompatActivity() {
    ...
    private lateinit var fabNewMeeting: FloatingActionButton
    ...
    private fun setupUI() {
        ...
        fabNewMeeting = findViewById(R.id.fab_new_meeting)
    ...
    private fun promptMeetingTitle() {
        ...
        input.hint = "Meeting Title (optional)"
        input.setTextColor(android.graphics.Color.WHITE)
        input.setHintTextColor(android.graphics.Color.GRAY)
        
        AlertDialog.Builder(this)
            .setTitle("Start Meeting Minutes")
            .setMessage("Enter a title for this meeting:")
            .setView(input)
